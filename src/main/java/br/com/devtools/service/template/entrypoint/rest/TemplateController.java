...
public class TemplateController {
  ...
  private final TemplateSearchAllUseCase searchAllUseCase;
  private final TemplateSearchOneUseCase searchOneUseCase;
  ...
  public ResponseEntity<Page<TemplateResponse>> readAll(
    ...
    return ok(searchAllUseCase.execute(filterRequest, pageable));
  }

  @GetMapping("/{id}")
  public ResponseEntity<TemplateResponse> readOne(@PathVariable("id") UUID id) {
    return ok(searchOneUseCase.execute(id));
  }
