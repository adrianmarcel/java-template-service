...
import br.com.devtools.service.template.core.usecase.TemplateSearchAllUseCase;
import br.com.devtools.service.template.core.usecase.TemplateSearchAllUseCaseImpl;
...
public class TemplateSearchAllUseCaseUnitTest {

  private TemplateSearchAllUseCase useCase;

  @Mock private TemplateSearchAllGateway searchAllGateway;

  @BeforeEach
  public void setUp() {
    useCase = new TemplateSearchAllUseCaseImpl(searchAllGateway);
  }
