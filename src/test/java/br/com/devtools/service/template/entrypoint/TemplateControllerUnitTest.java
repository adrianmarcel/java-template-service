package br.com.devtools.service.template.entrypoint;
...
import br.com.devtools.service.template.core.usecase.*;
import br.com.devtools.service.template.core.usecase.model.TemplateRequest;
import br.com.devtools.service.template.entrypoint.rest.TemplateController;
...
public class TemplateControllerUnitTest {
  ...
  @Autowired @MockBean private TemplateSearchAllUseCase searchAllUseCase;
  @Autowired @MockBean private TemplateSearchOneUseCase searchOneUseCase;
  ...
  public void testReadOneTemplatesWithErrorWhenTemplateNotFound() throws Exception {
    ...
    when(searchOneUseCase.execute(any(UUID.class))).thenThrow(exception);
  ...
  public void testReadOneTemplateWithSuccess() throws Exception {
    when(searchOneUseCase.execute(any(UUID.class)))
        .thenReturn(TemplateResponseFixture.validResponse());
